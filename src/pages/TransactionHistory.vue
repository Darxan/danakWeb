            ...
            <div class="container">
                ...
                <div class="card_container">
                    <div class="card">
                        ...
                        <p class="title">Do'stlaringizni taklif qiling
                            va ular uchun naqd pul olish
                        </p>
                        <p class="descr_text">
                            Havola yordamida ro'yxatdan o'tgandan so'ng, 
                            do'stingiz "Megabonus" sodiqlik dasturida 
                            "Savdogar" darajasini oladi. Do'stingiz har safar ...
                        </p>
                    </div>
                        <p><a href="#">"Do'stlardan keladigan daromad" haqida batafsil</a></p>
                    </div>
                    <div class="card">
                        <div class="img_block">
                            <img src="@/assets/images/human.png" alt="">
